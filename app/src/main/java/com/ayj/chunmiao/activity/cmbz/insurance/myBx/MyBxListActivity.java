...
import com.ayj.chunmiao.adapter.cmbz.bx.MyBxListAdapter;
    ...
    private void getList() {
        if (CommonUtils.isNetworkAvailable(mContext)) {
            ...
            OkHttpUtils.post()
                    ...
                    .addParams("json","{\"key\":\"\",\"msnid\":\""+mUserPerson.getData().get(0).getSnid()+"\",\"pwd\":\""+mUserPerson.getData().get(0).getPassWord()+"\",\"startrow\":\""+start+"\",\"endrow\":\""+(start + countSize)+"\"}")
                    .build()
