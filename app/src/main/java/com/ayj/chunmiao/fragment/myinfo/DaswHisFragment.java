...
public class DaswHisFragment extends BaseFragment {
    ...
    private AwardHisAdapter adapter;
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                switch (check.getErr()) {
                                    case 0:
                                        ...
                                        if (null == adapter) {
                                            adapter = new AwardHisAdapter(R.layout.item_award_his, list);
                                        ...
                                        adapter.setOnItemClickListener(new AwardHisAdapter.RecyclerViewOnItemClickListener() {
                                            @Override
                                            public void onItemClickListener(int pos) {
                                                Intent intent = new Intent(getActivity(), DaswDetailActivity.class);
                                                intent.putExtra("info",(Serializable) list.get(pos));
    ...
    protected int getLayoutId() {
        return R.layout.fragment_dasw_his;
    }
}
