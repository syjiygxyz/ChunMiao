package com.ayj.chunmiao.view.magicindicator.buildins.commonnavigator.indicators;
...
import com.ayj.chunmiao.view.magicindicator.FragmentContainerHelper;
import com.ayj.chunmiao.view.magicindicator.buildins.ArgbEvaluatorHolder;
